  ...
  return (
    <div className="space-y-6">
      ...
      <header className="rounded-2xl bg-white p-6 shadow-sm">
        <p className="text-xs font-bold uppercase text-slate-500">Atendimento</p>
        <h1 className="text-3xl font-black">WhatsApp</h1>
        <p className="mt-2 text-slate-500">Configure mensagens manuais. A integração oficial WhatsApp Business API fica para etapa futura.</p>
      </header>
      <form action={saveIntegration} className="rounded-2xl bg-white p-5 shadow-sm">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <label className="flex items-center gap-2 rounded-xl border border-slate-200 p-3 font-bold"><input name="enabled" type="checkbox" defaultChecked={Boolean(integration.is_enabled ?? integration.enabled)} disabled={!canEdit} /> Habilitar botão WhatsApp nos pedidos</label>
        ...
        <div className="mt-5 rounded-xl bg-slate-50 p-4">
          <p className="text-sm font-bold text-slate-500">Exemplo de link</p>
